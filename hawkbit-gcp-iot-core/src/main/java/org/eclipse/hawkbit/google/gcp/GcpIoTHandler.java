...
//		List<DeviceRegistry> gcp_registries = GcpIoTHandler.listRegistries(gcpProperties.getProjectId(), gcpProperties.getIotCoreRegion());
...
//	}
	...
	public List<Device> listDevices(String projectId, String cloudRegion, String registryName)
	...
	public boolean atLeastOnceConnected(String deviceId) {
		try {
			return atLeastOnceConnected(deviceId, 
					gcpProperties.getProjectId(), 
					gcpProperties.getIotCoreRegion(), 
	...
	private boolean atLeastOnceConnected(String deviceId, String projectId, String cloudRegion, String registryName)
			throws GeneralSecurityException, IOException {
		JsonFactory jsonFactory = JacksonFactory.getDefaultInstance();
		HttpRequestInitializer init = new RetryHttpInitializerWrapper(getCredentialsFromFile());
		final CloudIot service =
	...
	public List<DeviceRegistry> listRegistries(String projectId, String cloudRegion)
			throws GeneralSecurityException, IOException {
