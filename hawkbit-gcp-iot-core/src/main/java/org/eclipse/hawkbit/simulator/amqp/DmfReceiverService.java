...
public class DmfReceiverService extends MessageService {
	...
	private final GcpBucketHandler gcpBucketHandler;
	...
	DmfReceiverService(final RabbitTemplate rabbitTemplate, final AmqpProperties amqpProperties,
			...
			final DeviceSimulatorRepository repository, final GcpBucketHandler gcpBucketHandler) {
		super(rabbitTemplate, amqpProperties);
		this.spSenderService = spSenderService;
		this.deviceUpdater = deviceUpdater;
		this.repository = repository;
		this.gcpBucketHandler = gcpBucketHandler;
		LOGGER.info("Init");
	}
	...
	public void handleCancelDownloadAction(final Message message, final String thingId) {
		...
		JsonObject actionIdJson = gson.fromJson(new String(message.getBody()), JsonObject.class);
